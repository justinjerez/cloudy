...
export const Provider = (props) => {
    ...
    const printWeatherIcon = (code) => {
        ...
        if (code === 1006 || code === 1009) { return '005-cloudy.svg' }
        if (code === 1063 || code === 1183 || code === 1186 || code === 1240) { return '015-rainy.svg' }
        if (code === 1189 || code === 1192 || code === 1195 || code === 1243) { return '012-rainy.svg' }
